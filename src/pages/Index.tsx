    ...
    <Layout>
      <div className="flex flex-col gap-12 py-8">
        ...
        <section className="text-center space-y-6 py-12">
          <div className="inline-block p-2 bg-brand-purple-light rounded-full mb-4">
            <Award size={36} className="text-brand-purple" />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold tracking-tight">
            Refer Friends, <span className="text-brand-purple">Earn Rewards</span>
          </h1>
        ...
        <section className="py-12">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-md text-center flex flex-col items-center">
              <div className="bg-brand-purple-light p-3 rounded-full mb-4">
            ...
            <div className="bg-white p-8 rounded-lg shadow-md text-center flex flex-col items-center">
              ...
              <p className="text-gray-600">Get 10 points when someone signs up using your code</p>
            </div>
            
            <div className="bg-white p-8 rounded-lg shadow-md text-center flex flex-col items-center">
              <div className="bg-brand-purple-light p-3 rounded-full mb-4">
                <Gift className="h-6 w-6 text-brand-purple" />
              </div>
              <h3 className="text-xl font-bold mb-2">3. Redeem Rewards</h3>
              <p className="text-gray-600">Use your points to claim exclusive rewards and benefits</p>
            </div>
          </div>
        </section>

        {/* CTA Section */}
        <section className="bg-brand-purple text-white rounded-xl p-12 text-center my-12">
